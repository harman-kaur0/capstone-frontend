...
const Schedule = ({newApptFormShow, setNewApptFormShow, appt, setAppt}) => {
    ...
    return (
        <div style={{marginTop: "60px"}}>
            <Button style={{marginBottom: "10px"}} onClick={() => setNewApptFormShow(true)}>Make a new appointment</Button>
            <Scheduler
            ...
            <NewApptForm newApptFormShow={newApptFormShow} setNewApptFormShow={setNewApptFormShow} appt={appt} setAppt={setAppt}/>
